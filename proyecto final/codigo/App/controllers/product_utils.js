        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4" style="position: relative;">
                                <div class="card" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <button onclick="favoritosadd()" class="heart-icon  position-absolute top-0 end-0 p-2" aria-label="Add to favorites" style="background: none; border: none; cursor: pointer;">
